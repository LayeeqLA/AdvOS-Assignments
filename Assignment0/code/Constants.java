...
public class Constants {
    ...
    public static final int MIN_WAIT = 2000;
    public static final int MAX_WAIT = 16000;
    public static final int MIN_RANGE = 0;
    public static final int MAX_RANGE = 1000;
    public static final long CONNECT_WAIT = 15000L;
    public static final int CONNECT_MAX_ATTEMPTS = 10;
    ...
    public static int getRandomWait() {
        return getRandomNumber(MIN_WAIT, MAX_WAIT);
    }
